...
public class DeliveryCompleteOrderDetails2 extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(DeliveryCompleteOrderDetails2.this,LocationService2.class));
                Logout2.logout(DeliveryCompleteOrderDetails2.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DeliveryCompleteOrderDetails2.this,DeliveryBoyCompleteOrderActivity2.class));
                finish();
            }
        });
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(DeliveryCompleteOrderDetails2.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeliveryCompleteOrderDetails2.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(DeliveryCompleteOrderDetails2.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DeliveryCompleteOrderDetails2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
