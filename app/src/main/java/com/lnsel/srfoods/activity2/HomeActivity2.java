...
public class HomeActivity2 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_activity_pcj);
		setWidget();
	}
	...
	public void setWidget()
	{
		...
		*/
		...
		if (!hasPermissionLocation) {
			ActivityCompat.requestPermissions(HomeActivity2.this,
	...
	public void onClick(View view) {
		...
		case R.id.btnlogin:
			...
			startActivity(new Intent(HomeActivity2.this,LogintypeActivity2.class));
		...
		case R.id.btnRegister:
			...
			startActivity(new Intent(HomeActivity2.this,RegisterTypeActivity2.class));
			finish();
		...
		switch (requestCode)
		{
			...
			*/
			case REQUEST_ACCESS_FINE_LOCATION: {
				if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)
				{
					Toast.makeText(HomeActivity2.this, "Permission granted.", Toast.LENGTH_SHORT).show();
					//reload my activity with permission granted or use the features what required the permission
					//finish();
					//startActivity(getIntent());
				} else
				{
					Toast.makeText(HomeActivity2.this, "The app was not allowed to get your location. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
				}
			}
			...
			case REQUEST_WRITE_STORAGE: {
				...
				{
					Toast.makeText(HomeActivity2.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
				}
			}
			...
			case REQUEST_CALL: {
				...
				{
					Toast.makeText(HomeActivity2.this, "The app was not allowed to call. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
				}
			}
