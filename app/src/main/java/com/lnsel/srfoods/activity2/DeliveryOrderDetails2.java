...
import com.lnsel.srfoods.activity.DeliveryBoyPaymentReceive;
...
public class DeliveryOrderDetails2 extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_boy_order_details_pcj);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(DeliveryOrderDetails2.this,LocationService2.class));
                Logout2.logout(DeliveryOrderDetails2.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DeliveryOrderDetails2.this,DeliveryBoyOrderListActivity2.class));
                finish();
            }
        });
    ...
    public  void setwidget(){
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                    Intent intent = new Intent(DeliveryOrderDetails2.this, DeliveryBoyPaymentReceive2.class);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(DeliveryOrderDetails2.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeliveryOrderDetails2.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(DeliveryOrderDetails2.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DeliveryOrderDetails2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
