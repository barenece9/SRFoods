...
public class DispatchedOrderDetails2 extends Activity implements Response.Listener<byte[]>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout2.logout(DispatchedOrderDetails2.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(progressDialog2!=null)
                    progressDialog2.dismiss();
                startActivity(new Intent(DispatchedOrderDetails2.this,DealerPreviousActivity2.class));
                finish();
            }
        });
        headerTxt.setText("Dispatched Order Details");
            ...
            public void onClick(View v) {
               // downloadinvoice();
                ...
                if (!hasPermissionWrite) {
                    ActivityCompat.requestPermissions(DispatchedOrderDetails2.this,
                            new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                            REQUEST_WRITE_STORAGE);
                }else {

                    progressDialog1=new ProgressDialog(DispatchedOrderDetails2.this);
                    ...
                    request = new InputStreamVolleyRequest(Request.Method.GET, mUrl, DispatchedOrderDetails2.this, DispatchedOrderDetails2.this, null);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog2 == null) {
                    ...
                    progressDialog2 = new ProgressDialog(DispatchedOrderDetails2.this);
    ...
    public void onBackPressed() {
       /* if(webView.canGoBack()) {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DispatchedOrderDetails2.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(DispatchedOrderDetails2.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DispatchedOrderDetails2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_WRITE_STORAGE: {
                ...
                {
                    Toast.makeText(DispatchedOrderDetails2.this, "Permission granted.", Toast.LENGTH_SHORT).show();
                    //reload my activity with permission granted or use the features what required the permission
                    //finish();
                    //startActivity(getIntent());
                } else
                {
                    Toast.makeText(DispatchedOrderDetails2.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
            }
        }
