...
public class SalesPersonOrderDetails2 extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_person_order_details_pcj);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //stopService(new Intent(SalesPersonOrderDetails2.this,LocationService2.class));
                Logout2.logout(SalesPersonOrderDetails2.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SalesPersonOrderDetails2.this,SalesPersonActivity2.class));
                finish();
            }
        });
    ...
    public  void setwidget(){
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                    Intent intent = new Intent(SalesPersonOrderDetails2.this, DeliveryBoyPaymentReceive2.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SalesPersonOrderDetails2.this,DeliveryBoyOrderListActivity2.class));
                finish();
            }
        });
    }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(SalesPersonOrderDetails2.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SalesPersonOrderDetails2.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(SalesPersonOrderDetails2.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        url = Webservice2.DISPATCH_ORDER_INVOICE;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesPersonOrderDetails2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
