...
public class SalesParsonLoginActivity2 extends Activity {
    ...
    public void regwidgets(){
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SalesParsonLoginActivity2.this,LogintypeActivity2.class));
                finish();
            }
        });
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SalesParsonLoginActivity2.this,ForgotePassActivity2.class));
                finish();
            }
        });
        ...
        rememberme.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean check) {
                ...
                if(check){
                    ...
                    Sharepreferences2.setRememberMeSalePerson(SalesParsonLoginActivity2.this, dealerusername, dealerpassword, 1);

                }else{

                    Sharepreferences2.setRememberMeSalePerson(SalesParsonLoginActivity2.this, "", "", 0);
                }
            }
        });
        ...
        btndealerlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog2.showDialog(SalesParsonLoginActivity2.this, "Enter username");

                }else if(dealerpassword.equalsIgnoreCase("")){

                    CreateDialog2.showDialog(SalesParsonLoginActivity2.this, "Enter password");

                }else {
                    if(isNetworkAvailable()) {
                        dologin();
                    }else {
                        CreateDialog2.showDialog(SalesParsonLoginActivity2.this, "No Network Connection");
                    }
                }
            }
        });
        ...
        RememberData2 rememberData = Sharepreferences2.getRememberMeSalePerson(this);
    ...
    public  void dologin(){
        ...
        progressDialog=new ProgressDialog(SalesParsonLoginActivity2.this);
        ...
        url = Webservice2.SALES_PERSON_LOGIN;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesParsonLoginActivity2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public  void parselOGINresponse(String response){
        try {
            ...
            if(status.equalsIgnoreCase("success")){
                ...
                Sharepreferences2.setSalesPersoninfo(SalesParsonLoginActivity2.this,Employee_Code,Warehouse_Code);
               ...
               // Toast.makeText(getApplicationContext(),status+" : Login as "+Delear_Name,Toast.LENGTH_LONG).show();
                ...
                startActivity(new Intent(SalesParsonLoginActivity2.this,SalesPersonActivity2.class));
                finish();
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SalesParsonLoginActivity2.this);
