...
public class DealerDeliveryOrderDetails2 extends Activity implements Response.Listener<byte[]>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispatched_order_details_pcj);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout2.logout(DealerDeliveryOrderDetails2.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DealerDeliveryOrderDetails2.this,DealerPreviousActivity2.class));
                finish();
            }
        });
        headerTxt.setText("Delivery Order Details");
    ...
    public  void setwidget(){
        ...
        String url=Webservice2.DOWNLOAD_INVOICE+"?order_number="+orderno;
        startWebView(url);
            ...
            public void onClick(View v) {
               // downloadinvoice();
                ...
                if (!hasPermissionWrite) {
                    ActivityCompat.requestPermissions(DealerDeliveryOrderDetails2.this,
                            new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                            REQUEST_WRITE_STORAGE);
                }else {

                    progressDialog1=new ProgressDialog(DealerDeliveryOrderDetails2.this);
                    progressDialog1.setMessage("loading...");
                    progressDialog1.show();
                    progressDialog1.setCancelable(false);
                    progressDialog1.setCanceledOnTouchOutside(false);
                    //Change your url below
                    String mUrl=Webservice2.DISPATCH_ORDER_INVOICE_DOWNLOAD;
                    ...
                    request = new InputStreamVolleyRequest(Request.Method.GET, mUrl, DealerDeliveryOrderDetails2.this, DealerDeliveryOrderDetails2.this, null);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(DealerDeliveryOrderDetails2.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DealerDeliveryOrderDetails2.this);
    ...
    public void converthtmltopdf(String response){
        try {
           ...
           // String k = "<html><body>"+response+"</body></html>";
            String k=response;
            File file2 = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PCJ");
            if (!file2.exists()) {
                file2.mkdirs();
            }
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(DealerDeliveryOrderDetails2.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DealerDeliveryOrderDetails2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
        ...
        try {
            if (response!=null) {
                try{
                    ...
                    File file21 = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/PCJ");
                    if (!file21.exists()) {
                        file21.mkdirs();
                    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_WRITE_STORAGE: {
                ...
                {
                    Toast.makeText(DealerDeliveryOrderDetails2.this, "Permission granted.", Toast.LENGTH_SHORT).show();
                    //reload my activity with permission granted or use the features what required the permission
                    //finish();
                    //startActivity(getIntent());
                } else
                {
                    Toast.makeText(DealerDeliveryOrderDetails2.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
            }
        }
