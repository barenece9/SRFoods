...
import com.lnsel.srfoods.adapter2.SalesPersonCustomAdapter2;
...
public class SalesPersonNeworder2 extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sales_person_neworder_pcj);
    ...
    public  void setwidget(){
        ...
        arrayAdapter = new ArrayAdapter<String>(
                SalesPersonNeworder2.this, android.R.layout.simple_dropdown_item_1line,
                productList);
        ...
        spinnerdealerlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View arg1, int pos,
              ...
              //  doProductList(dealerId.get(pos));
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SalesPersonNeworder2.this,SalesPersonActivity2.class));
                finish();
            }
        });
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog2.showDialog(SalesPersonNeworder2.this, "Enter quantity");

                }else if(selectdealer.equalsIgnoreCase("")||selectdealer.equalsIgnoreCase("-1")){

                    CreateDialog2.showDialog(SalesPersonNeworder2.this, "Select dealer");

                }else if(selectproduct.equalsIgnoreCase("")||selectproduct.equalsIgnoreCase("-1")){

                    CreateDialog2.showDialog(SalesPersonNeworder2.this, "Select a product");
        ...
        adapterwarehouse = new ArrayAdapter<String>(SalesPersonNeworder2.this,R.layout.spinner_rows, warehouseList);
    ...
    public  void getorderno(){
        ...
        progressDialog1=new ProgressDialog(SalesPersonNeworder2.this);
        progressDialog1.setMessage("loading...");
        //  progressDialog.show();
        progressDialog1.setCancelable(false);
        progressDialog1.setCanceledOnTouchOutside(false);
        String url;
        url = Webservice2.SALES_PERSON_PRODUCT_NO;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesPersonNeworder2.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
            ...
            {
                RememberData2 rememberData= Sharepreferences2.getSalesPersoninfo(SalesPersonNeworder2.this);
    ...
    void doProductList(final String Dealer_Code)
    {
        progressDialog3=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    public  void addproduct(){
        progressDialog4=new ProgressDialog(SalesPersonNeworder2.this);
        ...
        try {
            ...
            if(status.equalsIgnoreCase("success")){
               ...
               // spinnerproductlist.setSelection(0);
                spinnerproductlist2.setText("");
                editquantity.setText("");
                CreateDialog2.showDialog(SalesPersonNeworder2.this,message);
    ...
    public  void getOrderDetails(){
        progressDialog5=new ProgressDialog(SalesPersonNeworder2.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                RememberData2 rememberData= Sharepreferences2.getDealerinfo(SalesPersonNeworder2.this);
                Map<String, String>  params = new HashMap<String, String>();
                params.put("dealerCode",selectdealer);
                params.put("orderNo",orderno);
    ...
    public  void  parseOrderDetails(String response){
       ...
       // callviewdialog();
        listView.setAdapter(new SalesPersonCustomAdapter2(SalesPersonNeworder2.this, listarray));
        //notifyAll();
    }

    public void callviewdialog(){
        // Create custom dialog object
        final Dialog dialog = new Dialog(SalesPersonNeworder2.this);
    ...
    public void dodeleteorder(final String slno){
        progressDialog6=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    public  void finalordersubmit(){
        progressDialog7=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SalesPersonNeworder2.this);
    ...
    public void clearalltemporder(){
       progressDialog8=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    public  void sendsms(){
        ...
        progressDialog9=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    public void backclearalltemporder(){
        final ProgressDialog progressDialog=new ProgressDialog(SalesPersonNeworder2.this);
    ...
    void doDealerList()
    {
        progressDialog2=new ProgressDialog(SalesPersonNeworder2.this);
