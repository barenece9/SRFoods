...
public class DeliveryBoyCompleteOrderListAdapter2 extends BaseAdapter{
    ...
    public DeliveryBoyCompleteOrderListAdapter2(DeliveryBoyCompleteOrderActivity2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DeliveryBoyCompleteOrderListAdapter2(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
       ...
       /* holder.call.setOnClickListener(new View.OnClickListener() {
        ...
        holder.view_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(context instanceof DeliveryBoyCompleteOrderActivity2){
                    ((DeliveryBoyCompleteOrderActivity2)context).viewdetails(position);
                }
