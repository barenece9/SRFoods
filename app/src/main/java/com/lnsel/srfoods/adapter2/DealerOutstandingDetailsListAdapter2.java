...
import com.lnsel.srfoods.activity2.DealerOutstandingDetails2;
import com.lnsel.srfoods.appconroller.AppController;

import java.util.ArrayList;
import java.util.HashMap;

public class DealerOutstandingDetailsListAdapter2 extends BaseAdapter{
    ...
    public DealerOutstandingDetailsListAdapter2(DealerOutstandingDetails2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DealerOutstandingDetailsListAdapter2(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.all_payment_list_items_pcj, null);
