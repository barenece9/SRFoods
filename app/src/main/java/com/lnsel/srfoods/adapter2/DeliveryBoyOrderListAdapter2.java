...
public class DeliveryBoyOrderListAdapter2 extends BaseAdapter{
    ...
    public DeliveryBoyOrderListAdapter2(DeliveryBoyOrderListActivity2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DeliveryBoyOrderListAdapter2(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.assigne_all_order_list_items_pcj, null);
        ...
        holder.call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent callIntent = new Intent(Intent.ACTION_CALL);
                ...
                if(context instanceof DeliveryBoyOrderListActivity2){
                    ((DeliveryBoyOrderListActivity2)context).call(number);
                }
        ...
        holder.view_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(context instanceof DeliveryBoyOrderListActivity2){
                    ((DeliveryBoyOrderListActivity2)context).viewdetails(position);
                }
