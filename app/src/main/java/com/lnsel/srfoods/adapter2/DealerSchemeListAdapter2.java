...
public class DealerSchemeListAdapter2 extends BaseAdapter{
    ...
    public DealerSchemeListAdapter2(SchemeView2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DealerSchemeListAdapter2(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.all_scheme_list_items_pcj, null);
