...
import com.lnsel.srfoods.activity2.SalesPersonNeworder2;
...
public class SalesPersonCustomAdapter2 extends BaseAdapter{
    ...
    public SalesPersonCustomAdapter2(SalesPersonNeworder2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public SalesPersonCustomAdapter2(SalesPersonNeworder2 mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(!listitems.get(position).get("Product_Images").equalsIgnoreCase("Image_Not_Found")) {
            holder.list_image.setImageUrl(Webservice2.PRODUCT_IMAGE+listitems.get(position).get("Product_Images"), imageLoader);
        }
       ...
       // holder.img.setImageResource(imageId[position]);
        holder.btn_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(context instanceof SalesPersonNeworder2){
                    ((SalesPersonNeworder2)context).yourDesiredMethod(slno);
                }
            }
        });
