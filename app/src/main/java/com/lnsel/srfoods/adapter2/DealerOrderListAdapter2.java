...
public class DealerOrderListAdapter2 extends BaseAdapter{
    ...
    public DealerOrderListAdapter2(DealerPreviousActivity2 mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DealerOrderListAdapter2(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
