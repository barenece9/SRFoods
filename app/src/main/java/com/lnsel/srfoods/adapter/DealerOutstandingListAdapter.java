...
public class DealerOutstandingListAdapter extends BaseAdapter{
    ...
    public DealerOutstandingListAdapter(DealerOutstanding mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DealerOutstandingListAdapter(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.all_outstanding_list_items, null);
