...
import com.lnsel.srfoods.activity.SalesPersonNeworder;
...
public class SalesPersonCustomAdapter extends BaseAdapter{
    ...
    public SalesPersonCustomAdapter(SalesPersonNeworder mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public SalesPersonCustomAdapter(SalesPersonNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
       ...
       // holder.img.setImageResource(imageId[position]);
        holder.btn_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(context instanceof SalesPersonNeworder){
                    ((SalesPersonNeworder)context).yourDesiredMethod(slno);
                }
            }
        });
        holder.list_image.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(!listitems.get(position).get("Product_Images").equalsIgnoreCase("Image_Not_Found")) {
                    String img_url=Webservice.PRODUCT_IMAGE+listitems.get(position).get("Product_Images");
                    showDialog(img_url);
                }
            }
        });
