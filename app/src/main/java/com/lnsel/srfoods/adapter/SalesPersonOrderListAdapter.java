...
public class SalesPersonOrderListAdapter extends BaseAdapter{
    ...
    public SalesPersonOrderListAdapter(SalesPersonPreviousActivity mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public SalesPersonOrderListAdapter(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
