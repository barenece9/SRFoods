...
public class PendingOrderListAdapter extends BaseAdapter{
    ...
    public PendingOrderListAdapter(ApprovalPendingOrderDetails mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public PendingOrderListAdapter(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.pending_order_list_items, null);
