...
public class DeliveryBoyOrderListAdapter extends BaseAdapter{
    ...
    public DeliveryBoyOrderListAdapter(DeliveryBoyOrderListActivity mainActivity, ArrayList<HashMap<String,String>> listitems1) {
    ...
    public DeliveryBoyOrderListAdapter(DealerNeworder mainActivity) {
        // TODO Auto-generated constructor stub
        context=mainActivity;
        /*inflater = ( LayoutInflater )context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* Intent callIntent = new Intent(Intent.ACTION_CALL);
                ...
                if(context instanceof DeliveryBoyOrderListActivity){
                    ((DeliveryBoyOrderListActivity)context).call(number);
                }
        ...
        holder.view_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(context instanceof DeliveryBoyOrderListActivity){
                    ((DeliveryBoyOrderListActivity)context).viewdetails(position);
                }
