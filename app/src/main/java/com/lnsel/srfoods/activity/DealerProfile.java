...
public class DealerProfile extends Activity {
    ...
    EditText etndealername,etndealeremail,etndealerephone,etndealeremobile,etndealereadditionalmobile,etndealerepassword,
            ...
            etndealerusername,etndealereconpassword,etndealereoldpassword;
    ...
    void getwidgets(){
        ...
        adapterState = new ArrayAdapter<String>(DealerProfile.this,R.layout.spinner_rows, stateList);
        ...
        adapterVatReg = new ArrayAdapter<String>(DealerProfile.this,R.layout.spinner_rows, vatreg);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout.logout(DealerProfile.this);
                finish();
            }
        });
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(progressDialog4!=null)
                    progressDialog4.dismiss();
                startActivity(new Intent(DealerProfile.this,DelareActivity.class));
                finish();
            }
        });
        ...
        btndealerpassupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog.showDialog(DealerProfile.this, "Enter old password");

                }else if(dealerepassword.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter new password");

                }else if(dealereconpassword.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter confirm password");

                }else if(!dealereconpassword.equalsIgnoreCase(dealerepassword)){

                    CreateDialog.showDialog(DealerProfile.this, "Confirm password not match");
        ...
        btndealerreg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer name");

                }else if(dealeremail.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer mail");

                } else if(!isValidEmail(dealeremail)){

                    CreateDialog.showDialog(DealerProfile.this, "email id not valid");
                    ...
                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer mobile no");

                } else if(dealereaddress.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer address");

                }else if(dealereshippingaddress.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer shipping address");

                }
                else if(dealerlocation.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer location");

                }
                else if(dealercity.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer city name");

                }
                else if(dealerzip.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DealerProfile.this, "Enter Dealer zip code");

                }
                else if(RegState.equalsIgnoreCase("-Select State-")){

                    CreateDialog.showDialog(DealerProfile.this, "Please Select state");

                }
                else if(VatRegType.equalsIgnoreCase("-Select Vat Reg Type-")){

                    CreateDialog.showDialog(DealerProfile.this, "Please Select Vat Reg Type");

                }else if(VatRegType.equalsIgnoreCase("Registered")){
                    if(dealervatno.equalsIgnoreCase("")){
                        CreateDialog.showDialog(DealerProfile.this, "Enter vat no");
                    }else {
                        doupdateprofile();
                    }
                }else {
    ...
    void doCityList()
    {
        progressDialog1=new ProgressDialog(DealerProfile.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DealerProfile.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public  void getprofiledetails(){
        progressDialog2=new ProgressDialog(DealerProfile.this);
        progressDialog2.setMessage("loading...");
        progressDialog2.show();
        progressDialog2.setCancelable(false);
        progressDialog2.setCanceledOnTouchOutside(false);
        String url;
        url = Webservice.DEALER_PROFILE_DETAILS;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                ...
                RememberData rememberData=Sharepreferences.getDealerinfo(DealerProfile.this);
                Map<String, String>  params = new HashMap<String, String>();
    ...
    public  void doupdateprofile(){
        ...
        progressDialog3=new ProgressDialog(DealerProfile.this);
    ...
    public void dpdatepassword(){
        ...
        progressDialog4=new ProgressDialog(DealerProfile.this);
        ...
        url = Webservice.DEALER_PASS_UPDATE;
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DealerProfile.this);
