...
public class ForgotePassActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ForgotePassActivity.this,DelareLoginActivity.class));
                finish();
            }
        });
        ...
        btnforgetpassdone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dealeremailid.equalsIgnoreCase("")){
                    CreateDialog.showDialog(ForgotePassActivity.this, "Enter registered mobile number");
                }else {
                    doforgotepassword();
                }
            }
    ...
    public void doforgotepassword(){
       progressDialog2=new ProgressDialog(ForgotePassActivity.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ForgotePassActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public  void sendsms(String Dealer_Mobile,String Password,String User_Name){
        ...
        progressDialog1=new ProgressDialog(ForgotePassActivity.this);
        ...
        String msgtext="Your SRFoods credential is Username : "+User_Name+" & Password : "+Password+", Thank You for contacting with us.";
        String encodedURL="";
        try {
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if(progressDialog1!=null)
                            progressDialog1.dismiss();
                        System.out.println("Error=========="+error);
                        Toast.makeText(ForgotePassActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(ForgotePassActivity.this);
