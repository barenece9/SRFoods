...
public class ConfirmOrderDetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout.logout(ConfirmOrderDetails.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(ConfirmOrderDetails.this,DealerPreviousActivity.class));
                finish();
            }
        });
    ...
    public  void getOrderdetails(){
        progressDialog=new ProgressDialog(ConfirmOrderDetails.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        progressDialog.setCancelable(false);
        progressDialog.setCanceledOnTouchOutside(false);
        String url;
        url = Webservice.CONFIRM_ORDER_DETAILS;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ConfirmOrderDetails.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
            protected Map<String, String> getParams()
            {
                ...
                RememberData rememberData= Sharepreferences.getDealerinfo(ConfirmOrderDetails.this);
    ...
    public  void  parseorderdetails(String response){
        ...
        order_list.setAdapter(new ConfirmOrderListAdapter(ConfirmOrderDetails.this,alllist));
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(ConfirmOrderDetails.this);
