...
public class DealerDeliveryOrderDetails extends Activity implements Response.Listener<byte[]>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout.logout(DealerDeliveryOrderDetails.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DealerDeliveryOrderDetails.this,DealerPreviousActivity.class));
                finish();
            }
        });
            ...
            public void onClick(View v) {
               // downloadinvoice();
                ...
                if (!hasPermissionWrite) {
                    ActivityCompat.requestPermissions(DealerDeliveryOrderDetails.this,
                            new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                            REQUEST_WRITE_STORAGE);
                }else {

                    progressDialog1=new ProgressDialog(DealerDeliveryOrderDetails.this);
                    ...
                    request = new InputStreamVolleyRequest(Request.Method.GET, mUrl, DealerDeliveryOrderDetails.this, DealerDeliveryOrderDetails.this, null);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(DealerDeliveryOrderDetails.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DealerDeliveryOrderDetails.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(DealerDeliveryOrderDetails.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DealerDeliveryOrderDetails.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_WRITE_STORAGE: {
                ...
                {
                    Toast.makeText(DealerDeliveryOrderDetails.this, "Permission granted.", Toast.LENGTH_SHORT).show();
                    //reload my activity with permission granted or use the features what required the permission
                    //finish();
                    //startActivity(getIntent());
                } else
                {
                    Toast.makeText(DealerDeliveryOrderDetails.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
            }
        }
