...
public class SchemeView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scheme_view);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SchemeView.this,DelareActivity.class));
                finish();
            }
        });
    ...
    public  void getSchemeStatus(){
        progressDialog2=new ProgressDialog(SchemeView.this);
        progressDialog2.setMessage("loading...");
        progressDialog2.setCancelable(false);
        progressDialog2.setCanceledOnTouchOutside(false);
        progressDialog2.show();
        String url;
        url = Webservice.DEALER_SCHEME_STATUS;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                       ...
                       /* if(progressDialog.isShowing())
                        ...
                        Toast.makeText(SchemeView.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
            protected Map<String, String> getParams()
            {
                ...
                RememberData rememberData= Sharepreferences.getDealerinfo(SchemeView.this);
    ...
    public  void getScheme(){
        progressDialog=new ProgressDialog(SchemeView.this);
        progressDialog.setMessage("loading...");
        progressDialog.setCancelable(false);
        progressDialog.setCanceledOnTouchOutside(false);
        progressDialog.show();
        String url;
        url = Webservice.DEALER_SCHEME;
    ...
    public  void  parseallorder(String response){
        ...
        scheme_list.setAdapter(new DealerSchemeListAdapter(SchemeView.this,alllist));
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SchemeView.this);
