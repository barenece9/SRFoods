...
//        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 4000, 0, listener);
    ...
    public class MyLocationListener implements LocationListener
    {
        ...
        public void onLocationChanged(final Location loc)
        {
            ...
            if(isBetterLocation(loc, previousBestLocation)) {
              ...
              //  Toast.makeText(getApplicationContext(),loc.getLatitude()+"current location"+loc.getLongitude(),Toast.LENGTH_LONG).show();
    ...
    public void sendtoserver(final Double lat, final Double lng){
        ...
        final ProgressDialog progressDialog=new ProgressDialog(MyService.this);
       ...
       // url = Webservice.POST_LAT_LONG;
        url="http://61.16.131.206/projects/srfoods/API/update_delivery_boy_position.php";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            {
                RememberData rememberData= Sharepreferences.getDeleveryinfo(MyService.this);
