...
public class DeliveryBoyOrderListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                stopService(new Intent(DeliveryBoyOrderListActivity.this,LocationService.class));
                Logout.logout(DeliveryBoyOrderListActivity.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DeliveryBoyOrderListActivity.this,DelivaryActivity.class));
                finish();
            }
        });
    ...
    public  void getAllOrdrList(){
        ...
        String url;
        url = Webservice.Assigned_Order_list_to_Delivery_Boy;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DeliveryBoyOrderListActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
            protected Map<String, String> getParams()
            {
                ...
                RememberData rememberData= Sharepreferences.getDeleveryinfo(DeliveryBoyOrderListActivity.this);
    ...
    public  void  parseallorder(String response){
        ...
        order_list.setAdapter(new DeliveryBoyOrderListAdapter(DeliveryBoyOrderListActivity.this,alllist));
    }


    public void viewdetails(int position){
        Intent intent=new Intent(DeliveryBoyOrderListActivity.this, DeliveryOrderDetails.class);
    ...
    public void call(String number){
        ...
        if (!hasPermissionCall) {
            ActivityCompat.requestPermissions(DeliveryBoyOrderListActivity.this,
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeliveryBoyOrderListActivity.this);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_CALL: {
                ...
                {
                    Toast.makeText(DeliveryBoyOrderListActivity.this, "Permission granted.", Toast.LENGTH_SHORT).show();
                    //reload my activity with permission granted or use the features what required the permission
                    //finish();
                    //startActivity(getIntent());
                } else
                {
                    Toast.makeText(DeliveryBoyOrderListActivity.this, "The app was not allowed to call. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
            }
