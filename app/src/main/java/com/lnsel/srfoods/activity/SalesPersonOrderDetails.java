...
public class SalesPersonOrderDetails extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // stopService(new Intent(SalesPersonOrderDetails.this,LocationService.class));
                Logout.logout(SalesPersonOrderDetails.this);
                finish();
            }
        });
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SalesPersonOrderDetails.this,SalesPersonActivity.class));
                finish();
            }
        });
    ...
    public  void setwidget(){
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                    Intent intent = new Intent(SalesPersonOrderDetails.this, DeliveryBoyPaymentReceive.class);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(SalesPersonOrderDetails.this,DeliveryBoyOrderListActivity.class));
                finish();
            }
        });
    }
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(SalesPersonOrderDetails.this);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SalesPersonOrderDetails.this);
    ...
    public void downloadinvoice(){
        final ProgressDialog progressDialog=new ProgressDialog(SalesPersonOrderDetails.this);
        progressDialog.setMessage("loading...");
        progressDialog.show();
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(SalesPersonOrderDetails.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
