...
public class DeliveryBoyLoginActivity extends Activity {
    ...
    public void regwidgets(){
        ...
        if (!hasPermissionLocation) {
            ActivityCompat.requestPermissions(DeliveryBoyLoginActivity.this,
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(DeliveryBoyLoginActivity.this,LogintypeActivity.class));
                finish();
            }
        });
        ...
        rememberme.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean check) {
                ...
                if(check){
                    ...
                    Sharepreferences.setRememberDeliveryboy(DeliveryBoyLoginActivity.this, dealerusername, dealerpassword, 1);

                }else{

                    Sharepreferences.setRememberDeliveryboy(DeliveryBoyLoginActivity.this, "", "", 0);
                }
            }
        });
        ...
        btndealerlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog.showDialog(DeliveryBoyLoginActivity.this, "Enter username");

                }else if(dealerpassword.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DeliveryBoyLoginActivity.this, "Enter password");
        ...
        RememberData rememberData = Sharepreferences.getRememberDeliveryboy(this);
    ...
    public  void dologin(){
        ...
        progressDialog=new ProgressDialog(DeliveryBoyLoginActivity.this);
        ...
        url = Webservice.DELIVERY_BOY_LOGIN;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DeliveryBoyLoginActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public  void parselOGINresponse(String response){
        try {
            ...
            if(status.equalsIgnoreCase("success")){
                ...
                Sharepreferences.setDeliveryinfo(DeliveryBoyLoginActivity.this,Employee_Code,Warehouse_Code);
               ...
               // Toast.makeText(getApplicationContext(),status+" : Login as "+Employee_Name,Toast.LENGTH_LONG).show();
                ...
                startService(new Intent(DeliveryBoyLoginActivity.this, LocationService.class));
              // startService(new Intent(DeliveryBoyLoginActivity.this, MyLocation.class));
               ...
               // stopService(new Intent(DeliveryBoyLoginActivity.this,LocationService2.class));
                ...
                startActivity(new Intent(DeliveryBoyLoginActivity.this,DelivaryActivity.class));
                finish();
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            case REQUEST_ACCESS_FINE_LOCATION: {
                ...
                {
                    Toast.makeText(DeliveryBoyLoginActivity.this, "Permission granted.", Toast.LENGTH_SHORT).show();
                    //reload my activity with permission granted or use the features what required the permission
                    //finish();
                    // startActivity(getIntent());
                } else
                {
                    Toast.makeText(DeliveryBoyLoginActivity.this, "The app was not allowed to get your location. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeliveryBoyLoginActivity.this);
