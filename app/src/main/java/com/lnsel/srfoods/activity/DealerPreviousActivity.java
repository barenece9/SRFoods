...
public class DealerPreviousActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(DealerPreviousActivity.this,DelareActivity.class));
                finish();
            }
        });
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Logout.logout(DealerPreviousActivity.this);
                finish();
            }
        });
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               // startActivity(new Intent(DealerPreviousActivity.this,ConfirmOrderDetails.class));
                ...
                if(status.equalsIgnoreCase("Confirmed")) {
                    Intent intent = new Intent(DealerPreviousActivity.this, ConfirmOrderDetails.class);
                    intent.putExtra("orderno", orderno);
                    startActivity(intent);
                    finish();
                }else if(status.equalsIgnoreCase("Approval Pending")){
                    Intent intent = new Intent(DealerPreviousActivity.this, ApprovalPendingOrderDetails.class);
                    intent.putExtra("orderno", orderno);
                    startActivity(intent);
                    finish();
                }else if(status.equalsIgnoreCase("Dispatched")){
                    Intent intent = new Intent(DealerPreviousActivity.this, DispatchedOrderDetails.class);
                    intent.putExtra("orderno", orderno);
                    startActivity(intent);
                    finish();
                }else if(status.equalsIgnoreCase("Delivered")){
                    Intent intent = new Intent(DealerPreviousActivity.this, DealerDeliveryOrderDetails.class);
                    intent.putExtra("orderno", orderno);
                    startActivity(intent);
                    finish();
                }else {
                    Toast.makeText(DealerPreviousActivity.this, "Sorry,Can't open this order", Toast.LENGTH_SHORT).show();
    ...
    public  void getAllOrdrList(){
            progressDialog=new ProgressDialog(DealerPreviousActivity.this);
            progressDialog.setMessage("loading...");
            progressDialog.show();
            progressDialog.setCancelable(false);
            progressDialog.setCanceledOnTouchOutside(false);
            String url;
            url = Webservice.DEALER_ALL_ORDER;
            ...
            StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    new Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            Toast.makeText(DealerPreviousActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                        }
                    }
            ){
                @Override
                protected Map<String, String> getParams()
                {
                    ...
                    RememberData rememberData= Sharepreferences.getDealerinfo(DealerPreviousActivity.this);
    ...
    public  void  parseallorder(String response){
        ...
        order_list.setAdapter(new DealerOrderListAdapter(DealerPreviousActivity.this,alllist));
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DealerPreviousActivity.this);
