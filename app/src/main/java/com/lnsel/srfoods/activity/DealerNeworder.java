...
public class DealerNeworder extends Activity  {
   ...
   // ArrayAdapter<String> adapterproduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dealer_neworder);
    ...
    public  void setwidget(){
        ...
        arrayAdapter = new ArrayAdapter<String>(
                DealerNeworder.this, android.R.layout.simple_dropdown_item_1line,
                productList);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // backclearalltemporder();
                startActivity(new Intent(DealerNeworder.this,DelareActivity.class));
                finish();
            }
        });
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog.showDialog(DealerNeworder.this, "Enter quantity");
                    ...
                    CreateDialog.showDialog(DealerNeworder.this, "Select a product");
        ...
        adapterwarehouse = new ArrayAdapter<String>(DealerNeworder.this,R.layout.spinner_rows, warehouseList);
    ...
    public  void getorderno(){
        ...
        progressDialog1=new ProgressDialog(DealerNeworder.this);
        progressDialog1.setMessage("loading...");
        //  progressDialog.show();
        progressDialog1.setCancelable(false);
        progressDialog1.setCanceledOnTouchOutside(false);
        String url;
        url = Webservice.PRODUCT_NO;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DealerNeworder.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ){
            @Override
            ...
            {
                RememberData rememberData= Sharepreferences.getDealerinfo(DealerNeworder.this);
    ...
    {
        progressDialog2=new ProgressDialog(DealerNeworder.this);
    ...
    void doProductList()
    {
        progressDialog3=new ProgressDialog(DealerNeworder.this);
    ...
    public  void addproduct(){
        progressDialog4=new ProgressDialog(DealerNeworder.this);
        ...
        try {
            ...
            if(status.equalsIgnoreCase("success")){
               ...
               // spinnerproductlist.setSelection(0);
                spinnerproductlist2.setText("");
                editquantity.setText("");
                CreateDialog.showDialog(DealerNeworder.this,message);
    ...
    public  void getOrderDetails(){
        progressDialog5=new ProgressDialog(DealerNeworder.this);
    ...
    public  void  parseOrderDetails(String response){
       ...
       // callviewdialog();
        listView.setAdapter(new CustomAdapter(DealerNeworder.this, listarray));
        //notifyAll();
    }

    public void callviewdialog(){
        // Create custom dialog object
        final Dialog dialog = new Dialog(DealerNeworder.this);
    ...
    public void dodeleteorder(final String slno){
        progressDialog6=new ProgressDialog(DealerNeworder.this);
    ...
    public  void finalordersubmit(){
        progressDialog7=new ProgressDialog(DealerNeworder.this);
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DealerNeworder.this);
    ...
    public void clearalltemporder(){
       progressDialog8=new ProgressDialog(DealerNeworder.this);
    ...
    public  void sendsms(){
        ...
        progressDialog9=new ProgressDialog(DealerNeworder.this);
    ...
    public void backclearalltemporder(){
        final ProgressDialog progressDialog=new ProgressDialog(DealerNeworder.this);
