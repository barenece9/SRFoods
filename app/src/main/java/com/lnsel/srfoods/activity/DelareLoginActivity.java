...
public class DelareLoginActivity extends Activity {
    ...
    public void regwidgets(){
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(DelareLoginActivity.this,LogintypeActivity.class));
                finish();
            }
        });
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(progressDialog!=null)
                    progressDialog.dismiss();
                startActivity(new Intent(DelareLoginActivity.this,ForgotePassActivity.class));
                finish();
            }
        });
        ...
        rememberme.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean check) {
                ...
                if(check){
                    ...
                    Sharepreferences.setRememberMe(DelareLoginActivity.this, dealerusername, dealerpassword, 1);

                }else{

                    Sharepreferences.setRememberMe(DelareLoginActivity.this, "", "", 0);
                }
            }
        });
        ...
        btndealerlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    CreateDialog.showDialog(DelareLoginActivity.this, "Enter username");

                }else if(dealerpassword.equalsIgnoreCase("")){

                    CreateDialog.showDialog(DelareLoginActivity.this, "Enter password");

                }else {
                    if(isNetworkAvailable()) {
                        dologin();
                    }else {
                        CreateDialog.showDialog(DelareLoginActivity.this, "No Network Connection");
                    }
                }
            }
        });
    ...
    public  void dologin(){
        ...
        progressDialog=new ProgressDialog(DelareLoginActivity.this);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(DelareLoginActivity.this, "Have a Network Error Please check Internet Connection.", Toast.LENGTH_LONG).show();
                    }
                }
        ){
            @Override
    ...
    public  void parselOGINresponse(String response){
        try {
            ...
            if(status.equalsIgnoreCase("success")){
                ...
                Sharepreferences.setDealerinfo(DelareLoginActivity.this,Delear_Code,Warehouse_Code);
               ...
               // Toast.makeText(getApplicationContext(),status+" : Login as "+Delear_Name,Toast.LENGTH_LONG).show();
                ...
                startActivity(new Intent(DelareLoginActivity.this,DelareActivity.class));
                finish();
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(DelareLoginActivity.this);
