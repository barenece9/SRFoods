...
public class RegisterTypeActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.btnRegCustomer:
			...
			startActivity(new Intent(RegisterTypeActivity.this,DelareRegActivity.class));
			finish();
			break;
	...
	public void onBackPressed() {
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(RegisterTypeActivity.this);
